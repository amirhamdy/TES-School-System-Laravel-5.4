                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control m-b" name="type" onchange="checkType(this.value)">
                            ...
                            <div id="student_data">
                                <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                                    <label for="level" class="col-md-4 control-label">Student Level</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                                    <label for="gender" class="col-md-4 control-label">Student Gender</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                    <label for="address" class="col-md-4 control-label">Student Address</label>
                                    <div class="col-md-6">
                                        <input id="address" type="text" class="form-control" name="address"
                                               value="{{ 'Cairo, Egypt' }}" required>
                            ...
                            <div id="parent_data" style="display: none">
    ...
    <script>
        function checkType(val) {
            if (val == "Student") {
                ...
                document.getElementById("parent_data").style.display = 'none';
                /*
                ...
                */
                ...
                document.getElementById("parent_data").style.display = 'inline';
                /*
